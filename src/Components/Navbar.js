...
const Navbar = () => {
  ...
  // No component name AuthContext ,but still we use them
  // console.log(user);
      ...
      >
        ...
        <div className="navbar-end">
          ...
          <button className="btn btn-ghost btn-circle hidden lg:flex">   
            {/* for large width search button shows ,but for small width it is hidden*/}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
              fill="none"
          ...
          {user ? (
            ...
            <button
              ...
              // when we click we go to Modal.js file ,where showModal() function is called
