...
const servicesList = [
  {
    ...
    image: "/images/home/category/Catering.png",
  },
  {
    id: 2,
    title: "Fast delivery",
    des: " jfvn frelkfn kfnvk kdck dkljl lkd",
    image: "/images/home/category/Delivery2.png",
  },
  {
    id: 3,
    ...
    <div className="section-container my-2">
      <div className="flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2 ">
          ...
          /> */}
          <div className="grid sm:grid-cols-2 grid-cols-1 gap-8 items-center mt-24 mb-24">
            {servicesList.map((services) => (
              <div
                key={services.id}
                className="shadow-md rounded-xl py-5 px-5 text-center bg-black rounded-full space-y-2 text-blue cursor-pointer hover:border-indigo-600 transition-all duration-100 hover:border hover:scale-90"
              >
                <img
                  src={services.image}
                  alt=""
                  className="mx-auto rounded-2xl bg-rgb(38, 38, 38) w-36 h-36"
                />
